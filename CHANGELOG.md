...
- `docs/bb-bash-agent-snippet.md` — clean, no-wrapper version of the bb-bash CLAUDE.md section. Used by `install-agent --claude` / `--agents` as the canonical source. (bb-bash-k9i)
